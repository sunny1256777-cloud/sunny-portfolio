            ...
            <Reveal delay={0.3}>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex items-center gap-2 rounded-full border border-foreground/20 px-5 py-2.5 text-sm font-medium transition-colors hover:border-[#0077b5] hover:text-[#0077b5]"
                >
                  <svg className="size-4 fill-current" viewBox="0 0 24 24">
